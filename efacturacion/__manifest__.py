# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base','sale','purchase','account','odoope_einvoice_base','odoope_ruc_validation','odoope_toponyms'],
    ...
    'data': [
        ...
        'data/sequences.xml',
        'reports/factura.xml',
        'reports/pleventas.xml',
        'wizard/pleventas_report_view.xml'
    ],
    'external_dependencies':{"python":['cryptography','ipaddress',"signxml","cffi"]},
